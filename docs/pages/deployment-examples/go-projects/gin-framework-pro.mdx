...
# Find Go installation path
which go  # Usually shows /usr/bin/go
ls -l /usr/bin/go  # Check actual path
```
...
> - The deployment process uses [makefile](https://github.com/celerbuild/celerbuild-example-go/blob/dev/makefile) for building and testing
